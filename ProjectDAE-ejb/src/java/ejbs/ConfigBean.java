...
public class ConfigBean {
    ...
    public void populateDB() { 
        ...
        // Clients
        clientBean.create(new ClientDTO("1234567", "Joao", "Leiria", "ADMIN", "AMC", "miguel.angelo_14@hotmail.com"));
        clientBean.create(new ClientDTO("c1", "c1", "Leiria", "ADMIN", "IPL", "miguel.angelo_14@hotmail.com"));
        clientBean.create(new ClientDTO("a123", "Zé", "Leiria", "ADMIN", "ABC", "miguel.angelo_14@hotmail.com"));
